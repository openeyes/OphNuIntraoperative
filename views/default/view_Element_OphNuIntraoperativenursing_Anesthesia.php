...
<section class="element">
	<header class="element-header">
		...
		<div class="element-data">
			...
			<div class="large-2 column"><div class="data-label"><?php echo CHtml::encode($element->getAttributeLabel('allergies_verfied'))?></div></div>
			<div class="large-10 column end"><div class="data-value"><?php echo $element->allergies_verfied ? 'Yes' : 'No'?></div></div>
		</div>
		<div class="row data-row">
