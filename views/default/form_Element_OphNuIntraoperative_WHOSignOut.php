...
?>
	<div class="element-fields">
		...
		<?php echo $form->multiSelectList($element, 'problems', 'problems', 'problem_id', CHtml::listData(OphNuIntraoperative_WHOSignOut_EquipmentProblems::model()->findAll(array('order' => 'name asc')),'id','name'), array(), array('label' => $element->getAttributeLabel('problems'), 'empty' => '- Please select -'), !$element->equipment_problems, false, null, false, false, array('label' => 3, 'field' => 4))?>
		<?php echo $form->textArea($element, 'equipment_problems_comments', array(), !$element->equipment_problems, array(), array('label' => 3, 'field' => 4))?>
		<?php echo $form->radioButtons($element, 'instructions_provided_id', CHtml::listData(OphNuIntraoperative_WHOSignOut_InstructionsProvided::model()->findAll(array('order' => 'display_order asc')),'id','name'), null, false, false, false, false, array(), array('label' => 3, 'field' => 4))?>
	</div>
