...
<table class="subtleWhite normalText">
	<tbody>
		...
		<tr>
			<td width="30%"><?php echo CHtml::encode($element->getAttributeLabel('iol_comments'))?></td>
			<td><span class="big"><?php echo CHtml::encode($element->iol_comments)?></span></td>
		</tr>
		<tr>
		...
		<tr>
			<td width="30%"><?php echo CHtml::encode($element->getAttributeLabel('ocular_sphere_ball_comments'))?></td>
			<td><span class="big"><?php echo CHtml::encode($element->ocular_sphere_ball_comments)?></span></td>
		</tr>
		<tr>
		...
		<tr>
			<td width="30%"><?php echo CHtml::encode($element->getAttributeLabel('glaucoma_valve_comments'))?></td>
			<td><span class="big"><?php echo CHtml::encode($element->glaucoma_valve_comments)?></span></td>
		</tr>
		<tr>
		...
		<tr>
			<td width="30%"><?php echo CHtml::encode($element->getAttributeLabel('lid_weight_comments'))?></td>
			<td><span class="big"><?php echo CHtml::encode($element->lid_weight_comments)?></span></td>
		</tr>
		<tr>
		...
		<tr>
			<td width="30%"><?php echo CHtml::encode($element->getAttributeLabel('suture_comments'))?></td>
			<td><span class="big"><?php echo CHtml::encode($element->suture_comments)?></span></td>
		</tr>
		<tr>
		...
		<tr>
			<td width="30%"><?php echo CHtml::encode($element->getAttributeLabel('drain_comments'))?></td>
			<td><span class="big"><?php echo CHtml::encode($element->drain_comments)?></span></td>
		</tr>
	</tbody>
</table>
