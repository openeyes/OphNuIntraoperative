...
?>
	<div class="element-fields">
		...
		<?php echo $form->multiSelectList($element, 'MultiSelect_dressing_items', 'dressing_itemss', 'dressing_item_id', CHtml::listData(OphNuIntraoperative_PostOp_DressingItem::model()->findAll(array('order'=>'display_order asc')),'id','name'), array(), array('empty' => '- Please select -', 'label' => 'Dressing','class' => 'linked-fields', 'data-linked-fields' => 'dressing_other', 'data-linked-values' => 'Other (please specify)'), false, false, null, false, false, array('label' => 3, 'field' => 4),false,'No dressing used')?>
