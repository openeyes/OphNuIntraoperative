...
<section class="element <?php echo $element->elementType->class_name?>"
	...
	<div class="element-fields">
		...
		<?php echo $form->radioBoolean($element, 'dressing_used', array('class' => 'linked-fields', 'data-linked-fields' => 'MultiSelect_dressing_items', 'data-linked-values' => 'Yes'), array('label' => 3, 'field' => 4))?>
		<?php echo $form->multiSelectList($element, 'MultiSelect_dressing_items', 'dressing_itemss', 'ophnuintraoperative_postop_dressing_items_id', CHtml::listData(OphNuIntraoperative_PostOp_DressingItems::model()->findAll(array('order'=>'display_order asc')),'id','name'), array(), array('empty' => '- Please select -', 'label' => 'Dressing items','class' => 'linked-fields', 'data-linked-fields' => 'dressing_other', 'data-linked-values' => 'Other (please specify)'), !$element->dressing_used, false, null, false, false, array('label' => 3, 'field' => 4))?>
