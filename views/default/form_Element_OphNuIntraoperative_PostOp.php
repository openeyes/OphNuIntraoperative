...
<section class="element <?php echo $element->elementType->class_name?>"
	...
	<div class="element-fields">
		...
		<?php echo $form->multiSelectList($element, 'MultiSelect_dressing_items', 'dressing_itemss', 'ophnuintraoperative_postop_dressing_items_id', CHtml::listData(OphNuIntraoperative_PostOp_DressingItems::model()->findAll(array('order'=>'display_order asc')),'id','name'), $element->ophnuintraoperative_postop_dressing_items_defaults, array('empty' => '- Please select -', 'label' => 'Dressing items','class' => 'linked-fields', 'data-linked-fields' => 'dressing_other', 'data-linked-value' => 'Other (please specify)'), !$element->dressing_used, false, null, false, false, array('label' => 3, 'field' => 4))?>
