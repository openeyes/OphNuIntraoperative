...
<section class="element <?php echo $element->elementType->class_name?>"
	...
	<div class="element-fields">
		...
		<?php echo $form->multiSelectList($element, 'MultiSelect_additional', 'additionals', 'ophnuintraoperative_operationprep_additional_id', CHtml::listData(OphNuIntraoperative_OperationPrep_Additional::model()->findAll(array('order'=>'display_order asc')),'id','name'), array(), array('empty' => '- Please select -', 'label' => 'Additional','class' => 'linked-fields', 'data-linked-fields' => 'additional_other', 'data-linked-value' => 'Other (please specify)'), false,false,null,false,false,array('label' => 3, 'field' => 4))?>
