...
<section class="element <?php echo $element->elementType->class_name?>"
	...
	<div class="element-fields">
		...
		<?php echo $form->radioBoolean($element, 'viscoelastic', array('class' => 'linked-fields', 'data-linked-fields' => 'viscoelastic_type_id,viscoelastic_quantity_id', 'data-linked-value' => 'Yes'), array('label' => 3, 'field' => 4))?>
		...
		<?php echo $form->radioBoolean($element, 'grounding_pad', array('class' => 'linked-fields', 'data-linked-fields' => 'grounding_pad_location_id,grounding_pad_side_id', 'data-linked-value' => 'Yes'), array('label' => 3, 'field' => 4))?>
		...
		<?php echo $form->dropDownList($element, 'post_skin_assessment_id', CHtml::listData(OphNuIntraoperative_OperationPrep_PostSkinAssessment::model()->findAll(array('order'=> 'display_order asc')),'id','name'),array('empty'=>'- Please select -','class' => 'linked-fields', 'data-linked-fields' => 'post_skin_assessment_other', 'data-linked-value' => 'Other (please specify)'),false,array('label'=>3,'field'=>4))?>
		...
		<?php echo $form->radioBoolean($element, 'nasal_throat_pack', array('class' => 'linked-fields', 'data-linked-fields' => 'nasal_insert_time,nasal_remove_time', 'data-linked-value' => 'Yes'), array('label' => 3, 'field' => 4))?>
		...
		<?php echo $form->multiSelectList($element, 'MultiSelect_additional', 'additionals', 'ophnuintraoperative_operationprep_additional_id', CHtml::listData(OphNuIntraoperative_OperationPrep_Additional::model()->findAll(array('order'=>'display_order asc')),'id','name'), $element->ophnuintraoperative_operationprep_additional_defaults, array('empty' => '- Please select -', 'label' => 'Additional','class' => 'linked-fields', 'data-linked-fields' => 'additional_other', 'data-linked-value' => 'Other (please specify)'), false,false,null,false,false,array('label' => 3, 'field' => 4))?>
