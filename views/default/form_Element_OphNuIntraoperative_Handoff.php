...
<section class="element <?php echo $element->elementType->class_name?>"
	...
	<div class="element-fields">
		...
		<?php echo $form->radioButtons($element, 'nonoperative_eye_protected_id', CHtml::listData(OphNuIntraoperative_Handoff_NonoperativeEyeProtected::model()->findAll(array('order' => 'display_order asc')),'id','name'),null,false,false,false,false,array('class' => 'linked-fields', 'data-linked-fields' => 'tape_or_shield_id', 'data-linked-value' => 'Yes'),array('label'=>3,'field'=>4))?>
