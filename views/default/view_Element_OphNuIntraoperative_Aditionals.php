...
<section class="element">
	<header class="element-header">
		...
		<div class="element-data">
			...
			<div class="large-2 column"><div class="data-label"><?php echo CHtml::encode($element->getAttributeLabel('aditionals'))?>:</div></div>
			<div class="large-10 column end"><div class="data-value"><?php if (!$element->aditionalss) {?>
							None
						<?php } else {?>
