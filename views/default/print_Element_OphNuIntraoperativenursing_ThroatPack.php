...
<table class="subtleWhite normalText">
	<tbody>
		<tr>
			<td width="30%"><?php echo CHtml::encode($element->getAttributeLabel('throat_pack_inserted'))?>:</td>
			<td><span class="big"><?php echo $element->throat_pack_inserted ? 'Yes' : 'No'?></span></td>
		</tr>
		<tr>
