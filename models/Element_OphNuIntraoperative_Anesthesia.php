 ...
 * @property OphNuIntraoperative_Anesthesia_HandOffFrom $hand_off_from
 * @property OphNuIntraoperative_Anesthesia_HandOffTo $hand_off_to
 * @property OphNuIntraoperative_Anesthesia_AnesthesiaType $anesthesia_type
 */

class Element_OphNuIntraoperative_Anesthesia  extends  BaseEventTypeElement
{
	public $service;
	...
	public function relations()
	{
		return array(
			...
			'hand_off_from' => array(self::BELONGS_TO, 'OphNuIntraoperative_Anesthesia_HandOffFrom', 'hand_off_from_id'),
			'hand_off_to' => array(self::BELONGS_TO, 'OphNuIntraoperative_Anesthesia_HandOffTo', 'hand_off_to_id'),
			'anesthesia_type' => array(self::BELONGS_TO, 'OphNuIntraoperative_Anesthesia_AnesthesiaType', 'anesthesia_type_id'),
		);
	}
