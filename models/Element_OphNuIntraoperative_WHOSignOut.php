...
class Element_OphNuIntraoperative_WHOSignOut extends  BaseEventTypeElement
{
	...
	{
		return 'et_ophnuintraoperative_whosignout';
	}
	...
	public function relations()
	{
		return array(
			...
			'labelling' => array(self::BELONGS_TO, 'OphNuIntraoperative_WHOSignOut_Labelling', 'labelling_id'),
			'instructions_provided' => array(self::BELONGS_TO, 'OphNuIntraoperative_WHOSignOut_InstructionsProvided', 'instructions_provided_id'),
			'problems_assignment' => array(self::HAS_MANY, 'OphNuIntraoperative_WHOSignOut_EquipmentProblems_Assignment', 'element_id'),
			'problems' => array(self::HAS_MANY, 'OphNuIntraoperative_WHOSignOut_EquipmentProblems', 'problem_id', 'through' => 'problems_assignment'),
		);
	}
