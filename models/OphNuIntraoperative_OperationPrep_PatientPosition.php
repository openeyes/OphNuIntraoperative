 ...
 */
class OphNuIntraoperative_OperationPrep_PatientPosition extends CActiveRecord
{
	/**
	 ...
	 * @return OphNuIntraoperative_OperationPrep_PatientPosition the static model class
	 */
