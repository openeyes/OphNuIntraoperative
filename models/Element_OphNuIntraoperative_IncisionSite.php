		...
		if (!empty($_POST['MultiSelect_incision'])) {
			...
			foreach ($existing_ids as $id) {
				if (!in_array($id,$_POST['MultiSelect_incision'])) {
					$item = Element_OphNuIntraoperative_IncisionSite_Incision_Assignment::model()->find('element_id = :elementId and ophnuintraopnurse_incisionsit_incision_id = :lookupfieldId',array(':elementId' => $this->id, ':lookupfieldId' => $id));
					if (!$item->delete()) {
