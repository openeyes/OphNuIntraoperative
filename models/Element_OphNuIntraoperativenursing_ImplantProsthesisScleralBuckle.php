 ...
 * @property OphNuIntraoperativenursing_ImplantProsthesisScleralBuckle_IolType $iol_type
 * @property OphNuIntraoperativenursing_ImplantProsthesisScleralBuckle_IolSize $iol_size
 */

class Element_OphNuIntraoperativenursing_ImplantProsthesisScleralBuckle  extends  BaseEventTypeElement
{
	public $service;
	...
	public function relations()
	{
		...
		return array(
			...
			'iol_type' => array(self::BELONGS_TO, 'OphNuIntraoperativenursing_ImplantProsthesisScleralBuckle_IolType', 'iol_type_id'),
			'iol_size' => array(self::BELONGS_TO, 'OphNuIntraoperativenursing_ImplantProsthesisScleralBuckle_IolSize', 'iol_size_id'),
		);
	}
