...
/**
 * This is the model class for table "ophnuintraoperative_postop_dressing_items".
 *
...
class OphNuIntraoperative_PostOp_DressingItems extends BaseActiveRecordVersioned
{
	/**
	...
	{
		return 'ophnuintraoperative_postop_dressing_items';
	}
