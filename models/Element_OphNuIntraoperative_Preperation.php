 ...
 * @property Element_OphNuIntraoperative_Preperation_PrepDone_Assignment $prep_dones
 * @property OphNuIntraoperative_Preperation_Viscoelastic $viscoelastic
 */

class Element_OphNuIntraoperative_Preperation  extends  BaseEventTypeElement
{
	public $service;
	...
	public function relations()
	{
		...
		return array(
			...
			'prep_dones' => array(self::HAS_MANY, 'Element_OphNuIntraoperative_Preperation_PrepDone_Assignment', 'element_id'),
			'viscoelastic' => array(self::BELONGS_TO, 'OphNuIntraoperative_Preperation_Viscoelastic', 'viscoelastic_id'),
		);
	}
